...
public class ComponentSelectionController implements Initializable {
    ...
    @Override public void initialize(URL location, ResourceBundle resources) {
            ...
            String databaseName = "dippr801sampleSQL";
            String url = "jdbc:sqlserver://localhost\\SQLEXPRESS:1433;dataBaseName=dippr801sampleSQL;user=ThermoTest;password=noseteolvide";
            ComponentManager manager = new ComponentManager(databaseName, driver, url);
            
            List<Component> components = manager.getAllComponents();
            
            componentsComboBox.getItems().addAll(components);
...
//        n_heptane.setPrsvKappa(0.0722d);
//        
...
//          
//        componentsComboBox.getItems().addAll(n_heptane,ethane,propane,methanol,n_hexane,water,cyclohexane);
//        componentsComboBox.setValue(methanol);
//        
...
//        componentTableView.setVisible(false);
    ...
    @FXML public void addComponent(ActionEvent event) {       
        UserProperties.addComponent((Component)componentsComboBox.getValue());      
    }
}
